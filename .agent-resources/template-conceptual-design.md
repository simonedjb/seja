# TEMPLATE - CONCEPTUAL DESIGN REFERENCE

> **How to use this template:** Copy this file to `project-conceptual-design-as-is.md` (for current state) and/or `project-conceptual-design-to-be.md` (for target state) and document your application's domain concepts. This file describes **what** the system is and **why** it exists — the domain — independently of the technology stack.
>
