---
designer_description: "When you or a review skill needs to pick a short-list of perspectives before loading any full file, I'm the compact index -- tag, name, and scope for each of the sixteen engineering and design lenses -- so the two-stage load protocol can decide which perspective files are worth reading for the change at hand without pulling all sixteen into context."
---

# Review Perspectives Index

Compact index for two-stage perspective loading. Select relevant perspectives from this table, then load only those files from `review-perspectives/`.
