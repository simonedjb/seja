#!/usr/bin/env python3
# designer: When you run /reflect over a telemetry window, I'm the
#   orchestrator behind the scenes -- I run the five reflection primitives
#   (sequence mining, duration anomalies, revision rate, stuck loops,
#   decision reversals) and compose their observations into a
#   non-prescriptive reflection report under `_output/reflections/`, so you
#   see patterns in how your own work unfolded without the file telling you
...
``${REFLECTIONS_DIR}/reflection-<id>-<slug>.md``. The orchestrator embeds primitive observation sentences
...
with this`` paragraph, which points the reader at ``/research`` for
prescriptive follow-up.
"""

# Rationale for design choices and historical context: see generate_reflection_report-rationale.md in this directory.
...
def compose_report(
    ...
    sections.append(
        ...
        "prescriptively, run `/research` with the specific pattern as your "
        "question -- for example, `/research Why do I amend /plan drafts 80% of "
