...
|-----|------|------|---------------|----------------------|
| EVL | Evaluators | [evaluators.md](general-communication/evaluators.md) | "Should we adopt this? What's the ROI?" | Executive overview, architecture overview, comparison guide, proof of value |
...
| CLT | Clients | [clients.md](general-communication/clients.md) | "Is the product I commissioned delivering the outcomes I need?" | Product vision alignment, delivery status, outcome evidence, metacommunication summary |
| USR | End Users | [end-users.md](general-communication/end-users.md) | "Does the software serve my needs well?" | Quality manifesto, feedback channels, accessibility statement |
| ACD | Academics | [academics.md](general-communication/academics.md) | "What's the theoretical contribution? How can I build on this?" | Theoretical foundation, research agenda, extension guide |
...
**Note on CLT role variants**: The Clients segment includes two role variants: CLT-D (Decision-maker, who shapes product design intent) and CLT-F (Funder, who provides financial backing). A single stakeholder may fill both roles. See [clients.md](general-communication/clients.md) for details.
...
The full Diataxis mapping with priorities and target lengths lives in [diataxis-mapping.md](general-communication/diataxis-mapping.md).
