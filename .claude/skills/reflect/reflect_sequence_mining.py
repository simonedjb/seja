#!/usr/bin/env python3
# designer: When /reflect walks your recent sessions, I'm the pattern extractor
#   that mines the order you invoked skills in -- the pairs and triples of
#   consecutive calls that keep repeating. You see your five most-common
#   two-skill and three-skill sequences in your reflection, which tells you
#   what your actual working loop looks like versus what you think it looks
#   like, and where a macro or a different default might save a hop.
...
# Rationale for design choices and historical context: see reflect_sequence_mining-rationale.md in this directory.
...
def analyze(window: list[dict]) -> dict:
    ...
    Returns:
        ...
        ``observations``, and ``degraded``. See the module docstring for the exact shape.
    """
    empty: dict = {
        "sequences": [],
        "top_5_first_order": [],
