...
> - `project/user-research-new.md` -- fresh user research insights not yet processed into design
> - `project/user-research-established.md` -- user research that has informed the current design
> - `project/journey-maps.md` -- visual journey maps for key user flows
...
2. Design
   ...
   > For detailed solution representations, see Section 13 below. For visual journey maps, see `project/journey-maps.md`.
...
> Describe how the user achieves their goals *with* the designed system. These are design decisions -- they reference personas and goals from user research (`project/user-research-new.md`, `project/user-research-established.md`) and optionally reference problem scenarios. Choose the representation that best fits your team's workflow -- solution scenarios (narrative), user stories (role-goal-benefit), or both.
