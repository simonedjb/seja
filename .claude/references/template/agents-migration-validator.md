...
designer_description: "When you are about to ship a schema change and want confidence the migration chain is still sound, I walk every revision your project holds -- checking for broken links, cycles, multiple heads, and the classic idempotency and dialect pitfalls that bite on re-run -- and hand you back a report of critical issues, warnings, and best-practice notes before you push it to a real database."
