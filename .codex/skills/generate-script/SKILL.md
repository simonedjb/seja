...
2. Reserve a global ID by running `python .codex/skills/scripts/reserve_id.py --type script --title '<descriptive-slug>'`. Use the returned 6-digit ID in the script's header documentation.
