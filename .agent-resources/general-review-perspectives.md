...
| Tag | Name | File |
|-----|------|------|
| SEC | Security | [sec.md](general-review-perspectives/sec.md) |
| PERF | Performance | [perf.md](general-review-perspectives/perf.md) |
| DB | Database | [db.md](general-review-perspectives/db.md) |
| API | API Design | [api.md](general-review-perspectives/api.md) |
| ARCH | Architecture | [arch.md](general-review-perspectives/arch.md) |
| DX | Developer Experience | [dx.md](general-review-perspectives/dx.md) |
| I18N | Internationalization | [i18n.md](general-review-perspectives/i18n.md) |
| TEST | Testability | [test.md](general-review-perspectives/test.md) |
| OPS | Operations / DevOps | [ops.md](general-review-perspectives/ops.md) |
| COMPAT | Compatibility | [compat.md](general-review-perspectives/compat.md) |
| DATA | Data Integrity & Privacy | [data.md](general-review-perspectives/data.md) |

## Design Perspectives

| Tag | Name | File |
|-----|------|------|
| UX | User Experience | [ux.md](general-review-perspectives/ux.md) |
| A11Y | Accessibility | [a11y.md](general-review-perspectives/a11y.md) |
| VIS | Visual Design | [vis.md](general-review-perspectives/vis.md) |
| RESP | Responsive Design | [resp.md](general-review-perspectives/resp.md) |
| MICRO | Microinteractions | [micro.md](general-review-perspectives/micro.md) |
