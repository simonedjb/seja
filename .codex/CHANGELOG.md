# SEJA-Codex Changelog

All notable changes to the SEJA-Codex framework are documented in this file.
...
### Changed
- References relocated from `.codex/skills/references/` to `.agent-resources/` (migration handled by upgrade script)
...
### Added
- Initial SEJA-Codex framework: 19 skills, 24 scripts, 5 agents, 6 rules
- References system in `.codex/skills/references/` (later moved to `.agent-resources/`)
