...
7. **Output:**
   ...
   b. If `--format html`: Run `python .claude/skills/scripts/md_to_html.py <markdown-file>` to generate a styled HTML file alongside it. If `project-communication-style.md` exists, pass it via `--style`.
