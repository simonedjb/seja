...
- [P1] Will a new contributor understand this without tribal knowledge?
...
- [P1] Are inline code comments, API docs, and architecture decision records kept up to date and co-located with the code they describe?
