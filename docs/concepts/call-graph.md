...
_Showing 80 of 268 edges. See the JSON for the full set._
...
| `check_api_auth_decorators.py` | `.claude/skills/scripts/critique_api_auth_decorators.py` | _(unused)_ |
| `check_api_contract_sync.py` | `.claude/skills/scripts/critique_api_contract_sync.py` | _(unused)_ |
| `check_backend_test_coverage.py` | `.claude/skills/scripts/critique_backend_test_coverage.py` | _(unused)_ |
| `check_changelog_append_only.py` | `.claude/skills/explain/critique_changelog_append_only.py` | `run_preflight_fast.py` |
| `check_conventions.py` | `.claude/skills/scripts/critique_conventions.py` | `run_preflight_fast.py` |
| `check_design_output.py` | `.claude/skills/scripts/critique_design_output.py` | `run_preflight_fast.py` |
| `check_docs.py` | `.claude/skills/critique/critique_docs.py` | `run_preflight_fast.py`, `/critique` |
| `check_frontend_test_coverage.py` | `.claude/skills/scripts/critique_frontend_test_coverage.py` | _(unused)_ |
| `check_git_freshness.py` | `.claude/skills/critique/critique_git_freshness.py` | `/critique` |
| `check_harness_drift.py` | `.claude/skills/scripts/critique_harness_drift.py` | _(unused)_ |
| `check_human_markers_only.py` | `.claude/skills/scripts/critique_human_markers_only.py` | `run_preflight_fast.py`, `/post-skill` |
| `check_i18n_keys.py` | `.claude/skills/scripts/critique_i18n_keys.py` | _(unused)_ |
| `check_migration_chain.py` | `.claude/skills/scripts/critique_migration_chain.py` | _(unused)_ |
| `check_plan_coverage.py` | `.claude/skills/design/critique_plan_coverage.py` | `run_preflight_fast.py`, `_internal/plan/roadmap`, `_internal/plan/standard` |
| `check_po_parity.py` | `.claude/skills/scripts/critique_po_parity.py` | _(unused)_ |
| `check_route_coverage.py` | `.claude/skills/scripts/critique_route_coverage.py` | _(unused)_ |
| `check_secrets.py` | `.claude/skills/design/critique_secrets.py` | `conversation_trace.py`, `run_preflight_fast.py`, `_internal/design/questionnaire` |
| `check_section_boundary_writes.py` | `.claude/skills/post-skill/critique_section_boundary_writes.py` | `run_preflight_fast.py` |
| `check_skill_spec.py` | `.claude/skills/scripts/critique_skill_spec.py` | `run_preflight_fast.py` |
| `check_skill_system.py` | `.claude/skills/scripts/critique_skill_system.py` | `run_preflight_fast.py` |
| `check_spec_conformance.py` | `.claude/skills/critique/critique_spec_conformance.py` | `run_preflight_fast.py`, `/critique` |
| `check_telemetry.py` | `.claude/skills/scripts/critique_telemetry.py` | `build_telemetry.py` |
| `check_unused_files.py` | `.claude/skills/scripts/critique_unused_files.py` | _(unused)_ |
| `check_validation_constants_sync.py` | `.claude/skills/scripts/critique_validation_constants_sync.py` | _(unused)_ |
| `check_version_changelog_sync.py` | `.claude/skills/scripts/critique_version_changelog_sync.py` | `run_preflight_fast.py` |
| `check_vuln_patterns.py` | `.claude/skills/scripts/critique_vuln_patterns.py` | _(unused)_ |
| `check_worktree_health.py` | `.claude/skills/scripts/critique_worktree_health.py` | _(unused)_ |
...
| `pending.py` | `.claude/skills/scripts/pending.py` | `generate_pending_roadmap.py`, `_internal/explain/spec-drift`, `_internal/plan/roadmap`, `/implement`, `/pending`, `/post-skill`, `/pre-skill`, `/research` |
...
| `reserve_id.py` | `.claude/skills/scripts/reserve_id.py` | `/critique`, `/communicate`, `/explain`, `/implement`, `/onboard`, `/plan`, `/qa-log`, `/reflect`, `/research` |
