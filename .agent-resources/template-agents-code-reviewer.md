...
2. **Read the project standards:**
   ...
   - Read `.agent-resources/project-backend-standards.md` for backend conventions
   - Read `.agent-resources/project-frontend-standards.md` for frontend conventions
   - Read `.agent-resources/project-security-checklists.md` for security checklists
   - Read `.agent-resources/project-testing-standards.md` for testing conventions
   - Read `.agent-resources/project-i18n-standards.md` for i18n conventions
