...
2. Copy the framework files (`.claude/` and `_references/`) from the SEJA repository into your project root.
...
All reference files live in `_references/` -- shared across both Claude and Codex frameworks:
