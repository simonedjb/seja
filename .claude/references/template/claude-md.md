...
This project uses Claude Code skills (`.claude/skills/`) and reference files (`product-design/`). Skills are invoked via `/skill-name`. Key skills: `/plan`, `/implement`, `/research`, `/critique review`, `/critique validate`.
