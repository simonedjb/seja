...
4. **Conflict check:**
   After each iteration with Phase 2 recommendations, check for inter-perspective contradictions. Resolve per `_references/general/review-perspectives.md` §Resolving Perspective Conflicts.
