...
| `project/product-design-as-coded.md` | Agent | Auto-updated by post-skill. Three H2 sections: Conceptual Design, Metacommunication, Journey Maps. Section boundary enforcement via `check_section_boundary_writes.py`. |
| `project/product-design-changelog.md` | Agent | Auto-updated by post-skill. Kept separate from product-design-as-coded.md. |
...
> **Note**: The `Human (markers)` classification (see `_references/general/shared-definitions.md` § File Maintainer Classification) is carried by `project/ux-research-results.md` and `project/product-design-as-intended.md`.
