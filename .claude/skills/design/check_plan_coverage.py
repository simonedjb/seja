#!/usr/bin/env python3
# designer: When you are deciding whether to cut a release, I line
#   every requirement in your design intent up against the plans that
#   claim to implement it and show you the ones nothing traces to.
#   You see the coverage gap grouped by area and severity, with
#   security gaps held to a stricter bar.
"""
...
Usage
-----
    python .claude/skills/design/check_plan_coverage.py [OPTIONS]
...
# Rationale for design choices and historical context: see check_plan_coverage-rationale.md in this directory.
...
def compute_coverage(
    ...
    # two-file layout during the workspace migration window.
