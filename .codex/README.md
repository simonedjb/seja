...
This directory is the Codex-native counterpart to the repository's `.claude/` framework.
...
Primary skills: `$advise`, `$check`, `$communication`, `$design`, `$document`, `$explain`, `$help`, `$implement`, `$onboarding`, `$plan`, `$qa-log`, `$seed`, `$upgrade`.
