...
**Important:** The repository does NOT contain project-specific files (`project/*.md`, `CLAUDE.md`, `.claude/settings.json`). These are generated by the `/design` skill in Part 3, tailored to your specific project. The repository DOES include generic rule and agent definitions that serve as starting points.
...
- `template/design-spec.md` -- Spec file template for non-interactive `/design`
