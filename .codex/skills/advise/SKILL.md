...
2. Reserve the next global ID by running `python .codex/skills/scripts/reserve_id.py --type inventory --title '<short title>'`. Use the returned 6-digit ID.
...
2. Reserve the next global ID by running `python .codex/skills/scripts/reserve_id.py --type advisory --title '<short title>'`. Use the returned 6-digit ID.
