...
3. **Phase 2 — Targeted deep-dives:**
   ...
   - Read the specific standards/reference file for that perspective (e.g., `product-design/security-checklists.md` for SEC, `product-design/standards.md § Backend` for DB/ARCH, `product-design/standards.md § Frontend` for UX/A11Y/VIS)
