...
- **New project**: extract the foundational SEJA framework (quickstart kit zip), then run `/quickstart .` to generate project-specific files.
- **Packaging**: run `/quickstart --package` to re-export portable `.claude/` resources as a zip.
