# TEMPLATE — METACOMMUNICATION TO-BE

<!-- maintained-by: human (designer) -->

> **How to use this template:** Copy this file to `project/metacomm-to-be.md` and document the metacommunication messages your system **should communicate** to the user. This file captures the designer's intent — what the system should convey, not what it currently does.
>
> For the definition of metacommunication message, see `general/shared-definitions.md`.
> For what is currently implemented, see `project/metacomm-as-is.md`.
