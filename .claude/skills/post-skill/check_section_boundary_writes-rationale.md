...
- **plan-000271**: The legacy `project-design/as-coded.md` path remains registered during the workspace upgrade window. Keeping it in the registry protects older workspaces until the setup upgrade path has removed the pre-unification file layout.
