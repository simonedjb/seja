...
| `AGENT_SPECS_DIR` | `project/agent` | Agent-facing structured specifications (in `project-design/`) |
...
| `CONSTITUTION_FILE` | `project/constitution.md` | Project constitution (in `project-design/`) |
| `DESIGN_INTENT` | `project/product-design-as-intended.md` | Unified working intent + Decisions + CHANGELOG (in `project-design/`) |
| `UX_RESEARCH` | `project/ux-research-results.md` | UX research: personas, problem scenarios, journeys, CHANGELOG (in `project-design/`) |
| `AS_CODED` | `project/product-design-as-coded.md` | Unified implementation state: Conceptual Design, Metacommunication, Journey Maps (in `project-design/`) |
