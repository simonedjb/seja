...
10 subagent prompts in `.codex/agents/`, organized by role:
...
7 rule files in `.codex/rules/` (including this one) -- auto-loaded when working on files matching the rule's scope.
