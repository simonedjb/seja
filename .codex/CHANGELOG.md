...
### Changed
- References relocated from `.codex/skills/references/` to `_references/` (migration handled by upgrade script)
...
- References system in `.codex/skills/references/` (later moved to `_references/`)
